...
Trước tôi đã giới thiệu cho các bạn về [Component trong Vue.js](/blog/bat-dau-voi-vue/#2-components). Bây giờ chúng ta thử tạo một component để tạo một _User_ như sau:

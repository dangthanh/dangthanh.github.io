...
tags: ["css", "sass", "postcss", "javascript"]
---

Lần trước tui có đề cập tới [PostCSS](/blog/redesign-va-nhung-gi-tui-hoc/#postcss). Nay tui sẽ giới thiệu tổng quan về PostCSS cho các bạn. Cũng như [Sass](/blog/su-dung-sass/), PostCSS cũng cung cấp các chức năng như Sass:

...
export default (props) => (
  <Fragment>
    ...
    <p class="max-w-2xl mx-auto px-5">
      Hi, I'm
      <strong class="font-semibold">Dang Van Thanh</strong> who living and
      working at
      <a
    ...
    <p class="max-w-2xl mx-auto px-5">
      ...
      ), too. Besides, I'm always shared the knowledge which I practiced and
      learned via
    ...
    <p class="max-w-2xl mx-auto px-5">
      Apart from code, I love cycling. Everyday, I'm riding a bike around the
      city for exercise in morning or go to work.
    </p>
